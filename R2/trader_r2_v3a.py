...
PRODUCT_PARAMS: Dict[str, dict] = {
    "ASH_COATED_OSMIUM": {
        **DEFAULT_PARAMS,
        ...
        # v3a (R2 AGGRESSIVE) : id_markout aggressive pour Osmium
        # Thresholds STRICTS pour minimiser faux positifs (Osm stable, bot signal rare)
        "id_markout": True,
        "id_markout_horizon": 500,
        "id_min_count": 6,       # plus strict que Pepper (4) : moins de faux positifs
        "id_min_mean": 3.0,      # plus strict : edge bot doit être ≥ 3 ticks de gain moyen
        "id_min_tstat": 2.0,     # plus strict : 95% confidence au lieu de 1.25
        "id_target": 40,         # plus modéré : 40/80 au lieu de 60/80 (Osm volatile)
    },

...
class Trader:
    ...
    def bid(self) -> int:
        # R2 MAF v3b AGGRESSIVE : bid 1000 XIREC pour quasi-garantir top 50%.
        # Break-even estimé : +1030 gain brut (Osm 41% fidélité × +25% volume).
        # Net EV si accepté : +30 XIREC (marginal mais ≈95% probabilité d'acceptation).
        # Pari : forte probabilité d'acceptation + pas de perte significative.
        return 1000

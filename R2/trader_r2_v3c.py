...
PRODUCT_PARAMS: Dict[str, dict] = {
    "ASH_COATED_OSMIUM": {
        **DEFAULT_PARAMS,
        ...
        # v3c (R2 AGGRESSIVE COMBO) : id_markout aggressive Osmium
        "id_markout": True,
...
class Trader:
    ...
    def bid(self) -> int:
        # R2 MAF v3c COMBO : bid 500 (compromise entre sécurité et EV positif).
        # Top 50% quasi-garanti, EV net +530 si accepté.
        return 500

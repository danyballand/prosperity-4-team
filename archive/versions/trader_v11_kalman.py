...
PRODUCT_PARAMS: Dict[str, dict] = {
    ...
    "ASH_COATED_OSMIUM": {
        **DEFAULT_PARAMS,
        ...
        "double_edge": True,    # v6 : 2 niveaux de quotes → plus de fills potentiels en live
        "inventory_clearing": True,   # v8 : 0-EV unwinds pour libérer la limite (Linear Utility trick)
        "clearing_threshold": 0.3,    # déclenche quand |pos| > 24 (optimal par sweep)
        "pennying": True,             # v9 : overbid/undercut les quotes externes (Frankfurt Hedgehogs)
        "min_pennying_edge": 1,       # on garde au moins 1 tick d'edge vs fv
    },
    ...
    "INTARIAN_PEPPER_ROOT": {
        **DEFAULT_PARAMS,
        ...
        # v11 : filtre de Kalman sur pepper (drift=0.5 conservateur, calibré par sweep)
        "use_kalman": True,
        "kalman_drift": 0.5,
        "kalman_Q": 0.25,
        "kalman_R": 50.0,

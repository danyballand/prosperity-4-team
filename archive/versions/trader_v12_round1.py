...
PRODUCT_PARAMS: Dict[str, dict] = {
    ...
    "ASH_COATED_OSMIUM": {
        **DEFAULT_PARAMS,
        "fixed_fv": 10000,
        "make_edge": 10,        # v12 : edge élargi (9990/10010) pour plus de profit par fill
        "take_width": 1,
        "skew_ticks_per_unit": 0.04,
        "double_edge": True,
        "inventory_clearing": True,
        "clearing_threshold": 0.3,
        "pennying": True,
        "min_pennying_edge": 1,
    },
    ...
    "INTARIAN_PEPPER_ROOT": {
        **DEFAULT_PARAMS,
        ...
        # v12 : Kalman drift=1.0 (plus agressif, backtest confirme le gain)
        "use_kalman": True,
        "kalman_drift": 1.0,
        "kalman_Q": 0.25,
        "kalman_R": 50.0,

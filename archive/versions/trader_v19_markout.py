...
PRODUCT_PARAMS: Dict[str, dict] = {
    "ASH_COATED_OSMIUM": {
        **DEFAULT_PARAMS,
        ...
        "use_obi_skew": False,
        "obi_strength": 0.5,
        # v19 : logger markout sur osmium aussi
    ...
    "INTARIAN_PEPPER_ROOT": {
        **DEFAULT_PARAMS,
        ...
        "informed_dry_run": True,  # v18: SHADOW MODE
...
def trade_product(product: str, state: TradingState, trader_data: dict) -> List[Order]:
    ...
    # v16 : INFORMED OVERRIDE (v17 fix : params passé explicitement)
    # v18 : SHADOW MODE — si dry_run=True, on log seulement sans modifier les ordres

...
PRODUCT_PARAMS: Dict[str, dict] = {
    ...
    # Produit volatile/trending : le TAKE nous fait perdre (on achète avant la continuation du trend).
    # On ne fait QUE du make avec un edge large → on ne gagne que sur les fills passifs.
    "INTARIAN_PEPPER_ROOT": {
        **DEFAULT_PARAMS,
        ...
        "disable_take": True,  # flag lu dans trade_product
    },

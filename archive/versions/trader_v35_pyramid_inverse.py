...
PRODUCT_PARAMS: Dict[str, dict] = {
    "ASH_COATED_OSMIUM": {
        **DEFAULT_PARAMS,
        ...
        # v35 Gemini : PYRAMIDE INVERSÉE — 70% du volume au prix le plus profond (limite bot)
        "pyramid_pct": (10, 20),   # 10/20/70 au lieu de 55/30/15
    },
    "INTARIAN_PEPPER_ROOT": {
        **DEFAULT_PARAMS,
        "position_limit": 80,
        "take_width": 3,
        "make_edge": 3,     # v35 : retour à 3 sur Pepper pour isoler le test pyramide inversée Osmium
